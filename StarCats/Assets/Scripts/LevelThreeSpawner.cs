...
public class LevelThreeSpawner : MonoBehaviour {
...
public GameObject planetA;
	...
	void FixedUpdate () {
		if (Time.fixedTime > nextSpawn && Time.timeSinceLevelLoad < 40) //start spawning after countdown, stop spawning 3 seconds before level ends
		{
...
//			GameObject[] planetOptions = new GameObject[] {planetA,planetA, enemies, planetB, planetC, enemies, enemies, planetB};
	...
	void WhatToSpawn() //45 seconds, 80 objects
	{
